...
class SearchBarDelegate extends SearchDelegate{
  ...
  Widget buildLeading(BuildContext context) {
    ...
    // return IconButton(icon:AnimatedIcon(icon: AnimatedIcons.menu_arrow,), onPressed: (){
    //   close(context, null);
    // });
  }
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    final suggestionList=query.isEmpty?recentSearch:search.where((input)=>input.startsWith(query)).toList();
